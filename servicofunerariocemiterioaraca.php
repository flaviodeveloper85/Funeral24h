...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 logo-container">
                            <h1 class="logo clearfix">
                                <span>Coroas de Flores - LIGUE: 11 2615-7248 - Faturamos para empresa, Boleto para 15 dias.</span> <a href="http://funeral24h.com.br/" title="funeral24h"><img src="http://funeral24h.com.br/images/logo.jpg" alt="Floricultura Homenagem Flores" width="200" height="109"></a>
                            </h1>
                        </div>
                                ...
                                <nav id="main-nav">
                                    ...
                                    <div class="menu-table">
                                        ...
                                        <ul class="menu clearfix">
                                            ...
                                            <li><a href="http://funeral24h.com.br/urnas.html">urnas</a></li>
											...
											<li><a href="http://funeral24h.com.br/anunciegratis.html">ANÚNCIE GRÁTIS</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
        ...
        <section id="content">
            ...
            <div id="breadcrumb-container">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="http://funeral24h.com.br/agenciafuneraria.html">Agência Funerária</a></li>
                        <li class="active">Funerária do Araçá</li>
                    </ul>
                </div>
            </div>					
          ...
          <li><a data-toggle="tab" href="#serv">Serviços e Preços</a></li>
        ...
        <div class="tab-content">
            ...
            <div id="detail" class="tab-pane fade">
                ...
                <h3 style="padding-top:30px">Detalhes</h3>

                <h5><strong>Funerária do Araçá</strong></h5>              
                <p>Telefone: 11 3231-5626 | 3214-0843 | 3231-5626</p>
                <p>Endereço: Av. Dr. Arnaldo, 300</p>
                <p>Bairro: Pacaembu</p>
            ...
            <div id="serv" class="tab-pane fade">
                ...
                <h3 style="padding-top:30px">Serviços e Preços</h3>
            ...
            <div id="photo" class="tab-pane fade">
                ...
                <h3 style="padding-top:30px">Fotos</h3>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 sidebar">
                        <div class="widget">
                            ...
                            <div class="widget subscribe">
                                ...
                                <form action="javascript:alert('Em desevolvimento.');" id="subscribe-form">
                                    ...
                                    <ul class="testimonials-list clearfix">
                                        <li>
                                            ...
                                            <figure class="clearfix">
                                                ...
                                                <figcaption>
                                                    <a href="javascript:alert('Em desevolvimento.');">Ana Falconi</a>
                                        ...
                                        <li>
                                            ...
                                            <figure class="clearfix">
                                                ...
                                                <figcaption>
                                                    <a href="javascript:alert('Em desevolvimento.');">Glaúcio Barbosa</a>
                                    ...
                                    <ul class="latest-posts-list clearfix">
                                        <li>
                                            ...
                                            <div class="latest-posts-meta-container clearfix">
                                                <div class="pull-left"><a href="javascript:alert('Em desevolvimento.');">Leia Mais...</a></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="latest-posts-meta-container clearfix">
                                                <div class="pull-left">
                                                    <a href="javascript:alert('Em desevolvimento.');">Leia Mais...</a>
                                                </div>
                                        ...
                                        <li>
                                            ...
                                            <h4><a href="javascript:alert('Em desevolvimento.');">Condolências com até -50% desc</a></h4>
    ...
    </div><a href="javascript:alert('Em desevolvimento.');" id="scroll-top" title="Scroll to Top"><i class="fa fa-angle-up"></i></a>
