<?php
	...
	// Query tb_cadastro
	$query_cadastro_anuncio = "INSERT INTO tb_anuncios (id_login,titulo,descricao,telefone,preco,images,cep,uf,cidade,active)
	values('$id_login', '$tituloAnuncio','$descricaoAnuncio','$telefone','$precoAnuncio','$gravaPathImg','$cep','$uf',
	'$cidade','1')";
