 <?php
    ...
    //pega id do anuncio
    $id_fun = $_GET['id_fun'];
    $_SESSION['id_fun'] = $id_fun;

    include("includes/conn.php");

    $select_funeraria = "SELECT * from tb_funerarias where id_login = '$id_fun'";
    $result = $conn->query($select_funeraria);
    $row = $result->fetch_assoc();

    $nome_empresa        = $row['nome_empresa'];
    $tel_empresa         = $row['telefone_empresa'];
    $logradouro          = $row['logradouro'];
    $num_empresa         = $row['numero'];
    $complemento_empr    = $row['complemento'];
    $cep_empresa         = $row['cep'];
    $bairro_empresa      = $row['bairro'];
    $cidade_empresa      = $row['cidade'];
    $uf_empresa          = $row['uf'];
    $img_empresa         = $row['img_logo'];
    $tp_particular       = $row['tp_particular'];
    $transp_aereo        = $row['transpAereo'];
    $transp_interm       = $row['transpIntermunicipal'];
    $plano_funeral       = $row['planoFuneral'];
    $atende24hs          = $row['atende24hs'];
...
<head>
	...
	<title>Funeral 24H, <?php echo $nome_empresa; ?></title>
            ...
            <div id="breadcrumb-container">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="http://funeral24h.com.br/agenciafuneraria.html">Funerárias</a></li>
                        <li class="active"><?php echo $nome_empresa; ?></li>
                    </ul>
                </div>
            </div>					
                ...
                <div class="row">
					...
					<div id="center_column" class="center_column col-xs-12 col-sm-9 form-group">
						...
						<header class="content-title">
							<h2 class="title"><?php echo $nome_empresa; ?></h2>
						</header>

						<ul class="nav nav-tabs" role="tablist">
							<li class="active"><a data-toggle="tab" href="#detail" >Detalhes</a></li>
							<li><a data-toggle="tab" href="#serv">Serviços</a></li>
						...
						<div class="tab-content"  style="padding-top: 20px;">
							...
							<div id="detail" class="tab-pane active">
                                ...
                                <fieldset>
                                    ...
                                    <p><strong>Telefone:</strong> <?php echo $tel_empresa; ?></p>
                                    <p><strong>Logradouro:</strong> <?php echo $logradouro; ?>, <?php echo $num_empresa;?> - <?php echo $complemento_empr;?></p>
                                    <p><strong>Bairro:</strong> <?php echo $bairro_empresa; ?></p>
                                    <p><strong>Cidade:</strong> <?php echo $cidade_empresa; ?></p>
                                    <p><strong>CEP:</strong> <?php echo $cep_empresa; ?></p>
                                    <p><strong>Cidade:</strong> <?php echo $cidade_empresa; ?></p>
                                    <p><strong>Estado:</strong> <?php echo $uf_empresa; ?></p>
                                    <p><strong>Nome do Responsavel:</strong> <?php echo $nome_resp; ?></p>
                                    <p><strong>Celular do Responsavel:</strong> <?php echo $cel_resp; ?></p>
                            ...
                            <div id="serv" class="tab-pane fade">
                                ...
                                <fieldset>
                                    ...
                                    <?php 
                                        ...
                                        switch ($tp_particular) {
                                            case 'n':
                                                echo "<p><strong>Funerária:</strong> Municipal </p>";
                                                break;

                                                case 's':
                                                echo "<p><strong>Funerária:</strong> Particular </p>";
                                                break;
                                        ...
                                        switch ($transp_aereo) {
                                            case 's':
                                                echo "<p><strong>Transporte aéreo:</strong> <i class='fa fa-check' aria-hidden='true' style='color:green'></i> </p>";
                                                break;

                                                case 'n':
                                                echo "<p><strong>Transporte aéreo:</strong> <i class='fa fa-times' aria-hidden='true' style='color:red'></i> </p>";
                                        ...
                                        switch ($transp_interm) {
                                            case 's':
                                                echo "<p><strong>Transporte intermunicipal:</strong> <i class='fa fa-check' aria-hidden='true' style='color:green'></i> </p>";
                                                break;

                                                case 'n':
                                                echo "<p><strong>Transporte intermunicipal:</strong> <i class='fa fa-times' aria-hidden='true' style='color:red'></i> </p>";
                                        ...
                                        switch ($plano_funeral) {
                                            case 's':
                                                echo "<p><strong>Plano funeral:</strong> <i class='fa fa-check' aria-hidden='true' style='color:green'></i> </p>";
                                                break;

                                                case 'n':
                                                echo "<p><strong>Plano funeral:</strong> <i class='fa fa-times' aria-hidden='true' style='color:red'></i> </p>";
                                        ...
                                        switch ($atende24hs) {
                                            case 's':
                                                echo "<p><strong>Atendimento 24h:</strong> <i class='fa fa-check' aria-hidden='true' style='color:green'></i> </p>";
                                                break;

                                                case 'n':
                                                echo "<p><strong>Atendimento 24h:</strong> <i class='fa fa-times' aria-hidden='true' style='color:red'></i> </p>";
							...
							<div id="photo" class="tab-pane fade">
                                ...
                                <img src="<?php echo $img_empresa; ?>" style="width:300px; height:300">                                    
							</div>
