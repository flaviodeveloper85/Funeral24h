...
*/
	...
	if($erro == 0){
		...
		// Query tb_cadastro
		$query_cadastro = "INSERT INTO tb_funerarias (id_login,nome_empresa,logradouro,numero,complemento,cep,bairro,cidade,uf,img_logo,tp_particular,transpAereo,transpIntermunicipal,planoFuneral,atende24hs,cad_status,nome_resp,cel_resp) values (last_insert_id(), '$nome_empresa','$logradouro','$numero','$complemento','$cep','$bairro','$cidade','$uf','$gravaPathImg','$tp_particular','$transAereo','$transInterm','$planFuneral','$atende24hs','1','$nome_resp','$cel_resp')";
